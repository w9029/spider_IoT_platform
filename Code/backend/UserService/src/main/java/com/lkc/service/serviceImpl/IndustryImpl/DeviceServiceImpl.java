...
public class DeviceServiceImpl implements DeviceService {
    ...
    public String addrule(Map<String, String> map) {
        ...
        if (map.get("type").equals("amateur")) {
            ...
            if (map.get("content").equals("-1")) {
                code = Long.toHexString(Long.valueOf(map.get("toaddr"))).toUpperCase();
    ...
    public String findataALl(String industryId, String unitId) {
        ...
        for (int i = 0; i < devices.size(); i++) {
            ...
            List<Map<Object, Object>> sensorchildren = new ArrayList<>();
            List<Map<Object, Object>> relaychildren = new ArrayList<>();
    ...
    public String deleteDevice(String industryId, String deviceId) {
        ...
        //删除device下所有sensor,并下发指令关闭对应sensor
        ...
        //删除device下所有relay,并下发指令关闭对应relay
