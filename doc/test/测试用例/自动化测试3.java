...
public class Test2 {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='确 定'])[3]/following::h2[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='这是产品概况的内容'])[1]/following::span[2]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='退出登录'])[1]/following::span[2]")).click();
    driver.findElement(By.xpath("//div[@id='ManageLeftPart']/div/ul/li[3]")).click();
    driver.findElement(By.xpath("//div[@id='ManageLeftPart']/div/ul/li[4]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='这是Page4的内容'])[1]/following::i[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='第一个点_3'])[1]/following::span[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='这是Page4的内容'])[1]/following::span[3]")).click();
    driver.findElement(By.xpath("//div[@id='ManageLeftPart']/div/ul/li[5]")).click();
  }
